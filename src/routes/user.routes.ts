...
router.get("/users/:id/password", authMiddleware, roleMiddleware("super_admin"), (req, res) => userController.revealUserPassword(req, res));
...
router.put("/update/events/:id/timeout", authMiddleware, roleMiddleware(...OPERATIONAL_ROLES), permissionMiddleware("action.event.edit"), requireActiveAcademicPeriod, (req, res) => eventController.updateEventTimeout(req, res));
router.delete(
  "/delete/events/:id",
  authMiddleware,
...
router.get("/events/:id/attendance-password", authMiddleware, roleMiddleware("super_admin"), (req, res) => eventController.revealAttendancePassword(req, res));
